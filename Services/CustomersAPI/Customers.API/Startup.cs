...
namespace Customers.API
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddDbContext<ApplicationDbDataContext>(options => options.UseNpgsql(Configuration["ConnectionStrings:ConnStr"]));

			services.AddScoped<ICustomerService, CustomerManager>();//Services Implement 
		}
